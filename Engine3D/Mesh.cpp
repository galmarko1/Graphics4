...
IndexedModel TethrahedronGenerator() {
    ...
    int r = ((colorsIndex + 1) & 0x000000FF) >> 0;
    int g = ((colorsIndex + 1) & 0x0000FF00) >> 8;
    int b = ((colorsIndex + 1) & 0x00FF0000) >> 16;
    Vertex vertices[] =
            {
                    Vertex(glm::vec3(1, 1, 1), glm::vec2(1, 0), glm::vec3(-1, 1, 1), glm::vec3(r, g, b)),
                    Vertex(glm::vec3(-1, 1, -1), glm::vec2(0, 0), glm::vec3(-1, 1, 1), glm::vec3(r, g, b)),
                    Vertex(glm::vec3(-1, -1, 1), glm::vec2(0, 1), glm::vec3(-1, 1, 1), glm::vec3(r, g, b)),
                    ...
                    Vertex(glm::vec3(1, 1, 1), glm::vec2(0, 1), glm::vec3(1, 1, -1), glm::vec3(r, g, b)),
                    Vertex(glm::vec3(-1, 1, -1), glm::vec2(1, 1), glm::vec3(1, 1, -1), glm::vec3(r, g, b)),
                    Vertex(glm::vec3(1, -1, -1), glm::vec2(1, 0), glm::vec3(1, 1, -1), glm::vec3(r, g, b)),
